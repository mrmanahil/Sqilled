...
const Register = (props) => {
	...
	return (
		<Typography >
			<div className="about-sec login_sec_bg">
			<div className="circle_bg"><img src="images/circled.png" /></div>
				<div className="container-full">
					<div className="row">
					<div className="col-md-4 loginLeftNewBg">							
							<div className="loginLeftNew">
							<div>
								
								<img src="images/login-otp-banner2.png"></img>
							<h3>Register</h3>
										...
										<div className="loginForm">
											...
											<div className="form-group">
												...
												>
													...
													<option value="W">Professional</option>
