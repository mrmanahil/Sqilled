								...
								<div className="search_list_box">
									...
									<div className="search_list_content">
										...
										<ul>
											...
											<li className="education_depart"><span className="education_new"><i class="fa fa-graduation-cap" aria-hidden="true"></i> {d.qualification || 'N/A'}</span> <span className="hourly_rate"  style={{textDecoration:'line-through'}}>{`${d.hourly_rate !== null ? '$' +  d.hourly_rate  + '/hr' : 'N/A'}`} </span><span className="free">Free</span></li>
											<li><i class="fa fa-certificate" aria-hidden="true"></i> {d.certification || 'N/A'}</li>										
											
											<li><button className="booknow" onClick={e => handleSearchDetails(e, d.id)}>Details</button></li>
										</ul>
									</div>
								</div>
							</div>
