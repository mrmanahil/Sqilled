...
const UPLOAD_VIDEO_RECODRING = loader(
  "../../graphql/search/uploadVideoRecording.graphql"
);
...
const EditProfile = (props) => {
      ...
      props.client
        ...
        .then((response) => {
          if (response.data.user) {
            ...
            let tempData = [];
            response.data.user.topicOfInterest &&
              response.data.user.topicOfInterest.map((d) => {
  ...
  const handleProfileImage = (e) => {
    ...
    reader.onloadend = function (e) {
      ...
      if (fileSize <= 3145728) {
        ...
        errors["profileError"] =
          "Image size can not exceed 3MB. Please try with a smaller image file.";
        setHasErrors(errors);
      }
    };
  };
  ...
  const validateForm = () => {
    ...
    if (userType === "R") {
      ...
      if (
        minHourlyRate &&
        parseFloat(minHourlyRate) >= parseFloat(maxHourlyRate)
      ) {
        formIsValid = false;
        errors["minHourlyRate"] =
          "Min Hour Should not be greather than max Hour RAteF";
      }

      if (
        maxHourlyRate &&
        parseFloat(maxHourlyRate) <= parseFloat(minHourlyRate)
      ) {
        formIsValid = false;
        errors["maxHourlyRate"] =
          "Max Hour Rate shoud not Be less than Min Hour Rate";
      }
    }
    setHasErrors(errors);
    return formIsValid;
  ...
  const submitProfile = (e) => {
    ...
    if (check) {
      ...
      let temp = [];
      topicOfInterest.length > 0 &&
        topicOfInterest.map((d) => {
          temp.push(d.value);
        });
  ...
  const uploadVideoProfile = (e) => {
    ...
    if (file) {
      ...
      if (
        ...
        errors.profileError =
          "Please upload only mov, mp4, mpg, & webm Videos.";
        errors.video = "Please upload only mov, mp4, mpg, & webm Videos.";
        setHasErrors(errors);
      }
  ...
  const postRes = (data) => {
    ...
    if (data.status === "SUCCESS") {
      ...
      errors.profileError = data.message;
      setHasErrors(errors);
    }
  };
  ...
  const [mutate] = useMutation(UPLOAD_VIDEO_RECODRING, {
    onCompleted({
      uploadVideoRecording: { status: status, message: message },
    }) {
      postRes({ status, message });
    },
    onError(error) {
      let errors = {};
      error.profileError = commonFunctions.parseGraphQLErrorMessage(error);
      setHasErrors(errors);
      $("#loadingDiv").hide();
    },
  });
            ...
            <form name="editProfile" onSubmit={submitProfile}>
              <div className="profile_box">
                <figure>
                  ...
                  {profileSuccess !== "" && (
                    <div className="success-msg">{profileSuccess}</div>
                  )}
                  {hasErrors.profileError && (
                    <div className="error">{hasErrors.profileError}</div>
                  )}
                </figure>
                <div className="form-group">
                  ...
                  <input
                    ...
                    className={`${
                      hasErrors.firstName !== undefined ? "is-invalid" : ""
                    }`}
                  />
                </div>
                <div className="form-group">
                  ...
                  <input
                    ...
                    className={`${
                      hasErrors.lastName !== undefined ? "is-invalid" : ""
                    }`}
                  />
                </div>
                <div className="form-group">
                  ...
                  <input
                    ...
                    className={`${
                      hasErrors.email !== undefined ? "is-invalid" : ""
                    }`}
                  />
                </div>
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={handleCity}
                    className={`${
                      hasErrors.city !== undefined ? "is-invalid" : ""
                    }`}
                  />
                </div>
                <div className="form-group">
                  ...
                  <input
                    ...
                    className={`${
                      hasErrors.state !== undefined ? "is-invalid" : ""
                    }`}
                  />
                </div>
                <div className="form-group">
                  ...
                  <input
                    ...
                    className={`${
                      hasErrors.country !== undefined ? "is-invalid" : ""
                    }`}
                  />
                </div>
                  ...
                  <React.Fragment>
                    <div className="form-group">
                      ...
                      <input
                        ...
                        className={`${
                          hasErrors.tagLine !== undefined ? "is-invalid" : ""
                        }`}
                      />
                    </div>
                    <div className="form-group">
                      ...
                      <input
                        ...
                        className={`${
                          hasErrors.qualification !== undefined
                            ? "is-invalid"
                            : ""
                        }`}
                      />
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        className={`${
                          hasErrors.certification !== undefined
                            ? "is-invalid"
                            : ""
                        }`}
                      />
                    ...
                    <div className="form-group">
                      ...
                      <textarea
                        ...
                        className={`${
                          hasErrors.experience !== undefined ? "is-invalid" : ""
                        }`}
                      ></textarea>
                    </div>
                    <div className="form-group video-upload">
                      ...
                      <input
                        ...
                        // value={profile}
                        className={`${
                          hasErrors.video !== undefined ? "is-invalid" : ""
                        }`}
                      />
                      <div className="record-video">
                        Don't have video?
                        <Link to="/record-self-video-profile"> Record</Link>
                      </div>
                    </div>
                    {hasErrors.videoError && (
                      <div className="error">{hasErrors.videoError}</div>
                    )}
                    <div className="form-group">
                      ...
                      <input
                        ...
                        className={`${
                          hasErrors.hourRate !== undefined ? "is-invalid" : ""
                        }`}
                      />
                  ...
                  <React.Fragment>
                    <div className="form-group">
                      ...
                      <Select
                        ...
                        className={`select-topics ${
                          hasErrors.topicOfInterest !== undefined
                            ? "is-invalid"
                            : ""
                        }`}
                        ...
                        value={
                          check === false
                            ? topicOfInterest
                            : topicOfInterestData.filter((obj) =>
                                topicOfInterest.includes(obj.value)
                              )
                        }
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        className={`hour-min ${
                          hasErrors.minHourlyRate !== undefined
                            ? "is-invalid"
                            : ""
                        }`}
                        placeholder="Min"
                      ...
                      <input
                        ...
                        className={`hour-max ${
                          hasErrors.maxHourlyRate !== undefined
                            ? "is-invalid"
                            : ""
                        }`}
                        placeholder="Max"
