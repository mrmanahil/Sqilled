            ...
            <div className="search-table">
              <table>
                <thead>
                  ...
                  <th>START TIME</th>
                  <th>END TIME</th>
                  <th className="action_center">Action</th>
                </thead>
                <tbody>
                  {(authorData && authorData.length > 0) && authorData.map((d, index) => {
                    return (
                      <tr key={index}>
                        ...
                        <td className="action_btns_new">
                          <span className="btn-group">
                            <i class="la la-pencil" aria-hidden="true" onClick={(e) => handleEdit(d)}></i>
                            <i class="la  la-trash" aria-hidden="true" onClick={(e) => handleDelete(d.id)}></i>
                          </span>
                        </td>
                      </tr>
                    )
